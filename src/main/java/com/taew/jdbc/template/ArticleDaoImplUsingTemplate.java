package com.taew.jdbc.template;
...
import com.taew.jdbc.raw.Article;
import com.taew.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/taewdb?user=taew&password=123456");
